...
const certifications = [
  ...
  },
  {
    ...
    icon: "trophy",
    image: "Pics/FSD_Udemy_Certificate.png"
  }
];
...
const Certifications = () => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 21h8M12 17v4m4-18v5a4 4 0 01-8 0V3m-2 4h12a2 2 0 002-2V3H4v2a2 2 0 002 2z" />
    </svg>
  );
      case 'globe':
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4a8 8 0 000 16 8 8 0 000-16zm0 0c2.21 0 4 3.582 4 8s-1.79 8-4 8-4-3.582-4-8 1.79-8 4-8z" />
    </svg>
  );
      default:
        return null;
